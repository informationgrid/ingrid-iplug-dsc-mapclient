...
//			  .addAttribute("codeListValue", "service").addText("service");
	...
	identificationInfo.addAttribute("uuid", luceneDoc.get("id")); //TODO das ist vielleicht nicht ganz richtig...
	...
	//TODO ---------- <gmd:identificationInfo/gmd:citation/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier> ----------
			// gleiches Problem wie oben, getCitationIdentifier macht was was ich nicht kann...
